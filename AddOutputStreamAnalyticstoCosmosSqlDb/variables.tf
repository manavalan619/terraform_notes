...
#   type        = string
#   description = "The container name in the Cosmos DB SQL Database."
# }
...
# variable "sta_outputcosmosdb_partitionKey" {
#   type        = string
#   description = "The name of the field in output events used to specify the key for partitioning output across collections. If 'collectionNamePattern' contains the {partition} token, this property is required to be specific."
# }
# variable "sta_outputcosmosdb_documentId" {
#   type        = string
