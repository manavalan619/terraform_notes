# Module AddSsisIrToAdf

## Description

This module adds SSIS to an Azure DataFactory

## Usage

### Module Definitions

- module location : providers/azure/AddSsisIrToAdf
...
- example for `dv`, `at` and `hp` :
  ...
  akv_tf_name = "akv-tf-dv-ne-<myProjectName>"
  ```
